...
class settings extends My_Controller
{
    ...
    public function check_pass()
    {
        ...
        $result=$this->Settings_model->get(array('password' => md5($pass),'login_id'=>$id,))->result_array();
        if($result)
        {
    ...
    public function password_change()
    {
        ...
        $result=$this->Settings_model->update($login_id,array('password'=>md5($repeat_p),'change_pass_status'=>1));
